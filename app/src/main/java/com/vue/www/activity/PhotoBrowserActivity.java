...
import com.vue.www.utils.FileUtils;
...
public class PhotoBrowserActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String urls = intent.getStringExtra("imageUrls");

        curImageIndex = Integer.parseInt(intent.getStringExtra("curImageIndex"));

        imageUrls = JSON.parseArray(urls, String.class);
